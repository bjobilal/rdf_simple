...
def calculate_fake_rate(sampleDir,prod,eras=['2016','2017','2018','2022','2023','2024'],ana='wmugamma',ptbins=[25.,30.,35.,40.,50.,60.,80.,150.],etabins=[-2.5,-2.0,-1.57,-1.44,-0.8,0.8,1.44,1.57,2.0,2.5],arrayName="fake_rate_VH",doMCClosure=False,outdir='.',file_extension='png'):
